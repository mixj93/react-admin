...
export const TimerEle = () => (
  <Timer />
)

class App extends React.Component<RouteConfigComponentProps<{}>, {}> {
  router: RouteConfig

  constructor(props: RouteConfigComponentProps<{}>) {
    super(props)
    this.router = this.props.route as RouteConfig
  }
        ...
        <Layout>
          ...
          <Content style={{ padding: '0 50px', marginTop: 64 }}>
            ...
            <div style={{ background: '#fff', padding: 24, minHeight: 380 }}>
              ...
              {renderRoutes(this.router.routes)}
            </div>
          </Content>
        </Layout>
      </Layout>
